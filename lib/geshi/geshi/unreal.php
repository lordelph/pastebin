 ...
 * uscript.php
 * ---------------------------------
 * Author: pospi (pospi at spadgos dot com)
 * Copyright: (c) 2007 pospi (http://pospi.spadgos.com)
 * Release Version: 1.0.0
 * CVS Revision Version: $Revision: 000 $
 * Date Started: 2007/05/21
 * Last Modified: $Date: 2007-05-21 23:51:03 +1000 (Mon, 21 May 2007) $
 *
...
$language_data = array (
	...
	'KEYWORDS' => array(
		1 => array(		//declaration keywords
			...
			'defaultproperties',
			'enum', 'event', 'extends', 'expands', 'final', 'guid', 'latent', 'localized',
			'new', 'noexport', 'operator', 'preoperator', 'optional', 'out',
			'private', 'public', 'protected', 'reliable', 'replication',
			'simulated', 'singular', 'static', 'struct', 'transient', 'unreliable',
